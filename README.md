...
| Path                    | npm                                                                                                                   | Status  |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------- | ------- |
| `packages/cli`          | `@rness/cli` — the CLI, command `rness`: `create`, `add`, `sync`, `context`, `validate`, `upgrade`, `login`, `logout` | 0.5.2   |
| `packages/create`       | `@rness/create` — `npm create @rness`                                                                                 | 0.5.2   |
| `packages/create-rness` | `create-rness` — `npm create rness`                                                                                   | 0.5.2   |
...
## Develop
    ...
    pnpm check:versions [--tag v0.5.2]            # lockstep versions; with the tag before a release
